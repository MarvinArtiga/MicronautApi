...
// Anotación para habilitar el entorno de pruebas en Micronaut.
@MicronautTest
public class BookAvailabilityTest {
    ...
    // Prueba que verifica el método estático fromValue() de BookAvailability.
    // Se asegura de que los strings se conviertan correctamente en los valores del enum.
    @Test
    ...
    // Solo se activa si la propiedad 'spec.name' tiene el valor 'BookAvailabilityTest'.
