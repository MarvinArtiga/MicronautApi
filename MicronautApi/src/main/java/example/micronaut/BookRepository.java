...
public interface BookRepository extends CrudRepository<BookEntity, Long> {  // <2>
    ...
    // Busca todos los libros que contengan el nombre del autor especificado.
    @NonNull
    List<BookEntity> findAllByAuthorContains(String author);                // <4>

    // Busca todos los libros que contengan el nombre especificado.
    @NonNull
    List<BookEntity> findAllByNameContains(String name);                    // <5>

    // Busca todos los libros que contengan tanto el nombre del autor como el nombre del libro.
    @NonNull
