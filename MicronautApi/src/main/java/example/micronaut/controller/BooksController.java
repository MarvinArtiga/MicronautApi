...
import micronaut.example.api.BooksApi;
...
//end::clazz[]
    ...
    //tag::inject[]
    // Repositorio inyectado mediante el constructor para realizar operaciones sobre la base de datos.
    ...
    public List<BookInfo> search(
        ...
        return searchEntities(bookName, authorName)
                .stream()
                .map(this::map) // <5> // Convierte cada entidad en un DTO BookInfo
                .toList();
    }
